...
import type { Building, Floor, Project, ProjectMedia, Unit } from "@/lib/types";
...
export default async function ProjectPage(props: PageProps<"/projects/[slug]">) {
  ...
  const [{ data: units }, { data: buildings }, { data: floors }, { data: media }, { data: userData }, { data: ownerName }] =
    await Promise.all([
